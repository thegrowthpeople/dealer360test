                    ...
                    <CardContent>
                      <div className="space-y-2 max-h-[450px] overflow-y-auto pr-2">
                        ...
                        {Array.from({ length: 15 }).map((_, index) => (
                          <div key={index} className="grid grid-cols-[90px_320px_100px_120px_110px_160px_280px_140px_140px_80px] gap-2 focus-within:bg-primary/5 focus-within:shadow-sm rounded-sm pr-1 py-1 -mr-1 -my-1 transition-all duration-150">
                            <FormField
                              control={form.control}
                                ...
                                <FormItem>
                                  <FormControl>
                                    <Input
                                      ...
                                      className="h-9 text-sm [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none focus-visible:border-l-4 focus-visible:border-l-primary pl-3"
                                    />
                                  </FormControl>
                                </FormItem>
                              )}
