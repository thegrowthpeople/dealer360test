    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="grid grid-cols-5 gap-2">
            <Card className="col-span-3 bg-gradient-to-br from-primary to-primary/80 border-0 shadow-md p-6 flex flex-col justify-center">
              <p className="text-sm font-medium text-primary-foreground/90 mb-2">Total Meetings</p>
              <p className="text-4xl font-bold text-primary-foreground">{formatNumber(totalMeetings)}</p>
            </Card>
            <Card className="col-span-2 border-0 shadow-md p-4 flex flex-col justify-center space-y-2">
              <div className="flex flex-col space-y-1">
                <span className="text-xs text-muted-foreground">Conquest</span>
                <span className="text-lg font-semibold text-foreground">{formatNumber(data["Conquest Meetings"])}</span>
              </div>
              <Separator />
              <div className="flex flex-col space-y-1">
                <span className="text-xs text-muted-foreground">Customer</span>
                <span className="text-lg font-semibold text-foreground">{formatNumber(data["Customer Meetings"])}</span>
              </div>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-5 gap-2">
            <Card className="col-span-3 bg-gradient-to-br from-primary to-primary/80 border-0 shadow-md p-6 flex flex-col justify-center">
              <p className="text-sm font-medium text-primary-foreground/90 mb-2">Quotes Issued</p>
            ...
            <Card className="col-span-2 border-0 shadow-md p-4 flex flex-col justify-center space-y-2">
              <div className="flex flex-col space-y-1">
                ...
                <span className="text-lg font-semibold text-foreground">{formatNumber(data["MBT Quotes Issued"])}</span>
              </div>
              <Separator />
              <div className="flex flex-col space-y-1">
                <span className="text-xs text-muted-foreground">Freightliner</span>
                <span className="text-lg font-semibold text-foreground">{formatNumber(data["FTL Quotes Issued"])}</span>
              </div>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-5 gap-2">
            <Card className="col-span-3 bg-gradient-to-br from-primary to-primary/80 border-0 shadow-md p-6 flex flex-col justify-center">
              <p className="text-sm font-medium text-primary-foreground/90 mb-2">Orders Received</p>
              <p className="text-4xl font-bold text-primary-foreground">{formatNumber(totalOrdersReceived)}</p>
            </Card>
            <Card className="col-span-2 border-0 shadow-md p-4 flex flex-col justify-center space-y-2">
              <div className="flex flex-col space-y-1">
                <span className="text-xs text-muted-foreground">Mercedes-Benz</span>
                <span className="text-lg font-semibold text-foreground">{formatNumber(data["MBT Orders Received"])}</span>
              </div>
              <Separator />
              <div className="flex flex-col space-y-1">
                <span className="text-xs text-muted-foreground">Freightliner</span>
                <span className="text-lg font-semibold text-foreground">{formatNumber(data["FTL Orders Received"])}</span>
              </div>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-5 gap-2">
            <Card className="col-span-3 bg-gradient-to-br from-primary to-primary/80 border-0 shadow-md p-6 flex flex-col justify-center">
              <p className="text-sm font-medium text-primary-foreground/90 mb-2">Orders Expected</p>
              <p className="text-4xl font-bold text-primary-foreground">{formatNumber(totalOrdersExpected)}</p>
            </Card>
            <Card className="col-span-2 border-0 shadow-md p-4 flex flex-col justify-center space-y-2">
              <div className="flex flex-col space-y-1">
                <span className="text-xs text-muted-foreground">Mercedes-Benz</span>
                <span className="text-lg font-semibold text-foreground">{formatNumber(data["MBT Orders Expected NW"])}</span>
              </div>
              <Separator />
              <div className="flex flex-col space-y-1">
                <span className="text-xs text-muted-foreground">Freightliner</span>
                <span className="text-lg font-semibold text-foreground">{formatNumber(data["FTL Orders Expected NW"])}</span>
              </div>
            </Card>
          </div>
        </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="grid grid-cols-5 gap-2">
            <Card className="col-span-3 bg-gradient-to-br from-primary to-primary/80 border-0 shadow-md p-6 flex flex-col justify-center">
              <p className="text-sm font-medium text-primary-foreground/90 mb-2">Pipeline Growth</p>
              <p className="text-4xl font-bold text-primary-foreground">{formatNumber(pipelineGrowth)}</p>
            </Card>
            <Card className="col-span-2 border-0 shadow-md p-4 flex flex-col justify-center space-y-2">
              <div className="flex flex-col space-y-1">
                <span className="text-xs text-muted-foreground">Mercedes-Benz</span>
                <span className="text-lg font-semibold text-foreground">{formatNumber(data["MBT Pipeline Growth"])}</span>
              </div>
              <Separator />
              <div className="flex flex-col space-y-1">
                <span className="text-xs text-muted-foreground">Freightliner</span>
                <span className="text-lg font-semibold text-foreground">{formatNumber(data["FTL Pipeline Growth"])}</span>
              </div>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-5 gap-2">
            <Card className="col-span-3 bg-gradient-to-br from-primary to-primary/80 border-0 shadow-md p-6 flex flex-col justify-center">
              <p className="text-sm font-medium text-primary-foreground/90 mb-2">Pipeline Lost</p>
              <p className="text-4xl font-bold text-primary-foreground">{formatNumber(pipelineLost)}</p>
            </Card>
            <Card className="col-span-2 border-0 shadow-md p-4 flex flex-col justify-center space-y-2">
              <div className="flex flex-col space-y-1">
                <span className="text-xs text-muted-foreground">Mercedes-Benz</span>
                <span className="text-lg font-semibold text-foreground">{formatNumber(data["MBT Pipeline Lost"])}</span>
              </div>
              <Separator />
              <div className="flex flex-col space-y-1">
                <span className="text-xs text-muted-foreground">Freightliner</span>
                <span className="text-lg font-semibold text-foreground">{formatNumber(data["FTL Pipeline Lost"])}</span>
              </div>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-5 gap-2">
            <Card className="col-span-3 bg-gradient-to-br from-[#0EA5E9] to-[#0EA5E9]/80 border-0 shadow-md p-6 flex flex-col justify-center">
              <p className="text-sm font-medium text-white/90 mb-2">Mercedes-Benz Pipeline</p>
              <p className="text-4xl font-bold text-white">{formatNumber(mbtPipeline)}</p>
            </Card>
            <Card className="col-span-2 border-0 shadow-md p-4 flex flex-col justify-center space-y-2">
              <div className="flex flex-col space-y-1">
                <span className="text-xs text-muted-foreground">This QTR</span>
                <span className="text-lg font-semibold text-foreground">{formatNumber(data["MBT Pipeline Size This QTR"])}</span>
              </div>
              <Separator />
              <div className="flex flex-col space-y-1">
                <span className="text-xs text-muted-foreground">Next QTR</span>
                <span className="text-lg font-semibold text-foreground">{formatNumber(data["MBT Pipeline Size Next QTR"])}</span>
              </div>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-5 gap-2">
            <Card className="col-span-3 bg-gradient-to-br from-[#9b87f5] to-[#9b87f5]/80 border-0 shadow-md p-6 flex flex-col justify-center">
              <p className="text-sm font-medium text-white/90 mb-2">Freightliner Pipeline</p>
              <p className="text-4xl font-bold text-white">{formatNumber(ftlPipeline)}</p>
            </Card>
            <Card className="col-span-2 border-0 shadow-md p-4 flex flex-col justify-center space-y-2">
              <div className="flex flex-col space-y-1">
                <span className="text-xs text-muted-foreground">This QTR</span>
                <span className="text-lg font-semibold text-foreground">{formatNumber(data["FTL Pipeline Size This QTR"])}</span>
              </div>
              <Separator />
              <div className="flex flex-col space-y-1">
                <span className="text-xs text-muted-foreground">Next QTR</span>
                <span className="text-lg font-semibold text-foreground">{formatNumber(data["FTL Pipeline Size Next QTR"])}</span>
              </div>
            </Card>
          </div>
        </div>
